<template lang="html">
  ...
  <section class="topbarmenu">
    <div>
      <b-navbar class="navbarStyle" toggleable="lg" type="dark" >
        <b-navbar-brand href="#">Call eSports</b-navbar-brand>
        ...
        <b-collapse id="nav-collapse" is-nav>
          <b-navbar-nav>
            ...
            <b-nav-item href="#">
              <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" fill="currentColor" class="bi bi-diagram-2-fill" viewBox="0 0 16 16">
